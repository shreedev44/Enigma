...
import { RecruiterSignupFormAction, RecruiterSignupFormType } from "@/types/formTypes";
...
const SignupForm = ({ className, ...props }: React.ComponentProps<"div">) => {
  ...
  const reducer = (state: RecruiterSignupFormType, action: RecruiterSignupFormAction) => {
    switch (action.type) {
          ...
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="text-center text-sm">
                ...
                <a className="underline underline-offset-4 cursor-pointer" onClick={() => navigate('/recruiter/signin')}>
                  Sign In
                </a>
              </div>
            </div>
