...
const getParameterTypeMap = (parameters: { name: string; type: DataTypes }[]) => {
...
export const validateTestCase = (testCase: TestCaseType, parameters: { name: string; type: DataTypes }[]) => {
